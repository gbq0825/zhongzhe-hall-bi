<template>
    <div>
        ...
        <div class="mediaBody">
            <!-- 第一个摄像头 -->
            <div class="mediaItem1" v-if="monitorList[0]" style="width:25%">
                <img src="../../../../assets/img/quanping.png" class="quanping"
                    @click="handleOpen(0,monitorList[0].cameraIndexCode)" />
                <img :src="monitorList[0].coverPic" class="mediaImg" />
                <div class="mediaTitle">{{monitorList[0].cameraName}}</div>
            </div>
            <!-- 第二个摄像头 -->
            <div class="mediaItem1" v-if="monitorList[1]" style="width:15%">
                <img src="../../../../assets/img/quanping.png" class="quanping"
                    @click="handleOpen(1,monitorList[1].cameraIndexCode)" />
                <img :src="monitorList[1].coverPic" class="mediaImg" />
                <div class="mediaTitle">{{monitorList[1].cameraName}}</div>
            </div>

            <!-- 剩下几个摄像头 -->
            <ul class="mediaView" v-if="monitorList.length && monitorList.length>=2">
                <li v-for="(item,index) in monitorList.slice(2,12)" :key="index" class="mediaItem">
                    <img src="../../../../assets/img/quanping.png" class="quanping"
                        @click="handleOpen(index+2,item.cameraIndexCode)" />
            ...
            <el-pagination class="pagination" hide-on-single-page :current-page="pageNo" :pager-count="5"
                :page-size="12" background layout="prev, pager, next" :total="monitorTotal"
...
export default {
    ...
    methods: {
        ...
        async queryMonistorUrl(code) {
            // this.videoUrl = 'https://e-sign.dms.t.cn-np.com/files/m3u8_file/c4b94118-3c8d-4410-9987-985c2b44c278/c4b94118-3c8d-4410-9987-985c2b44c278.m3u8'
            // this.showMedia = true
            // this.$nextTick(() => {
